...
void Init_DCU_METER_ID(void)
{
    ...
    //
    temp = *(__IO uint8_t*)ADDR_DEV_SERIAL;   //Dev Seri. Bay gio seri va ID la kh�c nhau
	if (temp != 0xFF)
	{
    ...
    if(sInformation.fUpdateFirmware == 1)
    {
        ...
        }else   //neu o 1 buoc bat ki nao khac
        {
            if ((sDCU.Mode_Connect_Now !=  sDCU.Mode_Connect_Future) && (sDCU.Mode_Connect_Future != 0)) 
            {
                ...
                sSim900_status.Count_Hard_Reset = TIME_RESET_MCU - 1;     //Set bien count n�y chi can 2 lan nua thi se reset chip: 1 lan update va 1 lan khoi dong lai
...
//            else
//                sTCP.aNeed_Send[UPDATE_FIRM_FAIL] = 1; //Them ban tin bao fail de reset chip. Vi truoc do d� cho dung thuc thi task ReadMeter v� Flash
//            sSim900_status.Step_Control_u8 = GSM_HARD_RESET;
//            sDCU.Mode_Connect_Now = MODE_CONNECT_DATA;
//            break;
//        case GSM_CLOSING:	// Reset SIM900
//            if ((sDCU.Mode_Connect_Now != sDCU.Mode_Connect_Future) && (sDCU.Mode_Connect_Future != 0))   //Check xem c� phai updateFirm k
//            {
//                sDCU.Mode_Connect_Now 			= sDCU.Mode_Connect_Future;
//                sSim900_status.Count_Soft_Reset = 0;	// reset Count
//                sDCU.Mode_Connect_Future 		= 0;
//                sSim900_status.Count_Hard_Reset = TIME_RESET_MCU - 1;     //Set bien count n�y chi can 2 lan nua thi se reset chip
//            }
//            Step_Config(&sSim900_status.No_Process_i16,_AT_TCP_OUT_DATAMODE,_AT_TCP_OUT_DATAMODE);
...
//            sSim900_status.Call_Ready_u8 = 0;
//            sSim900_status.Sim_inserted_u8 = 0;
//            if (Cal_Time_s(sSim900_status.Systick_LandMarkReset_u32,RT_Count_Systick_u32) > 120) { // off trong 2 ph�t
//                sSim900_status.Step_Control_u8 = GSM_HARD_RESET;
//            }
//            break;
//        case GSM_MEAS_RSSI:
...
//                        }
//                        //Cuoi ngay thoat che do data mode de l�y stime tu tram
...
//                    sSim900_status.CheckConnectATCommand = AT_CMD_WAIT;
//                    break;
//                case AT_DISCONNECT_SERVICE:  //ngat lu�n dich v?
...
{	
    ...
    //
    //Check xem c� URC n�o khong. URC la dieu kien quan trong nhat. phai dat truoc vi sau do n� bi convert het sang chu thuong
    if ((sSim900_status.Step_Control_u8 != GSM_HTTP_TRANSFER_DOWNLOAD) && (sSim900_status.Step_Control_u8 != GSM_FTP_TRANSFER_DOWNLOAD)) 
...
void _fFTP_READ_2(truct_String *str_Receiv)
{
	...
	if (Pos >= 0)
	{
        ...
        {   
            ...
            //Neu la Pack dau tien, Check 32 byte header xem c� chu: ModemFirmware:SV1.1,0x0800C000
...
void Togle_LED(void)
{
    ...
    else if (((sDCU.Status_Meter_u8 == 0) || (sDCU.Status_Meter_u8 == 3)) && (Check_HardPin_DectectMeter() == 0))  //k c� cap
...
//                                    //Check xem c� phai ban tin cat ra khong/ Check kis tu ETX o byte thu 1199. Vi dang cat 1200 byte
...
//                break;
//            case 1:
//                if ((Queue_Flash_MInfo.Mess_Status_ui8 == 1) || (sTCP.aCountRetryMess[DATA_OPERATION] >= MAX_RETRY_SEND_1MESS))   //gia tri bien n�y lay thong qua con tro:sFlash_Update v� sMQTT.paNeed_Send[var] = sFlash_Update;
//                {
...
{
    if(Type == 1)     //luu g�i 1 khi cat ra vao
    {
...
//                break;
//            case 1:
//                if ((Queue_Flash_MBill.Mess_Status_ui8 == 1) || (sTCP.aCountRetryMess[DATA_HISTORICAL] >= MAX_RETRY_SEND_1MESS))   //gia tri bien n�y lay thong qua con tro:sFlash_Update v� sMQTT.paNeed_Send[var] = sFlash_Update;
//                {
...
//                break;
//            case 1:
//                if ((Queue_Flash_MLpf.Mess_Status_ui8 == 1) || (sTCP.aCountRetryMess[DATA_LOAD_PROFILE] >= MAX_RETRY_SEND_1MESS))   //gia tri bien n�y lay thong qua con tro:sFlash_Update v� sMQTT.paNeed_Send[var] = sFlash_Update;
//                {
//                    //Save mess into flash
